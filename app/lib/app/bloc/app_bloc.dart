...
class AppBloc extends BaseBloc<AppEvent, AppState> {
  ...
  Future<void> _onAppInitiated(
    ...
    await runBlocCatching(
      action: () async {
        ...
        _updateTimeAgoLocal(languageCode: output.languageCode);
        emit(state.copyWith(
  ...
  void _updateTimeAgoLocal({required LanguageCode languageCode}) {
    TimeAgoConfig.getInstance()
        .setTimeAgoLocale(locale: languageCode.localeCode);
  }
}
