...
import '../utils/photo_view_hero_attributes.dart';
...
class PhotoViewCoreState extends State<PhotoViewCore>
  ...
  Widget _buildChild() {
    return widget.hasCustomChild ? widget.customChild! : _buildImageWidget();
  }

  Widget _buildImageWidget() {
    final imgProvider = widget.imageProvider;
    if (imgProvider is NetworkImage) {
      return CachedNetworkImage(
        imageUrl: imgProvider.url,
